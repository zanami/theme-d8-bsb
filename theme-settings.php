 ...
 */
function bsb_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  $form['layout']['container']['bsb_fluid_container'] = array(
    '#type' => 'checkbox',
    '#title' => t('Fluid container'),
    '#default_value' => theme_get_setting('bsb_fluid_container'),
    '#description' => t('Use <code>.container-fluid</code> class. See : !bsb_link', array(
      '!bsb_link' => Drupal::l('Fluid container' , Url::fromUri('http://getbootstrap.com/css/' , ['absolute' => TRUE , 'fragment' => 'grid-example-fluid'])),
    )),
  );
  ...
  $form['layout']['sidebar_position']['bsb_sidebar_position'] = array(
    '#type' => 'select',
    '#title' => t('Sidebars Position'),
    '#default_value' => theme_get_setting('bsb_sidebar_position'),
    '#options' => array(
      'left' => t('Left'),
      'both' => t('Both sides'),
      'right' => t('Right'),
  ...
  $form['layout']['sidebar_position']['bsb_content_offset'] = array(
    '#type' => 'select',
    '#title' => t('Content Offset'),
    '#default_value' => theme_get_setting('bsb_content_offset'),
    '#options' => array(
      0 => t('None'),
      1 => t('1 Cols'),
      2 => t('2 Cols'),
  ...
  $form['layout']['sidebar_first']['bsb_sidebar_first_width'] = array(
    '#type' => 'select',
    '#title' => t('Sidebar First Width'),
    '#default_value' => theme_get_setting('bsb_sidebar_first_width'),
    '#options' => array(
      2 => t('2 Cols'),
      3 => t('3 Cols'),
      4 => t('4 Cols'),
  ...
  $form['layout']['sidebar_first']['bsb_sidebar_first_offset'] = array(
    '#type' => 'select',
    '#title' => t('Sidebar First Offset'),
    '#default_value' => theme_get_setting('bsb_sidebar_first_offset'),
    '#options' => array(
      0 => t('None'),
      1 => t('1 Cols'),
      2 => t('2 Cols'),
  ...
  $form['layout']['sidebar_second']['bsb_sidebar_second_width'] = array(
    '#type' => 'select',
    '#title' => t('Sidebar Second Width'),
    '#default_value' => theme_get_setting('bsb_sidebar_second_width'),
    '#options' => array(
      2 => t('2 Cols'),
      3 => t('3 Cols'),
      4 => t('4 Cols'),
  ...
  $form['layout']['sidebar_second']['bsb_sidebar_second_offset'] = array(
    '#type' => 'select',
    '#title' => t('Sidebar Second Offset'),
    '#default_value' => theme_get_setting('bsb_sidebar_second_offset'),
    '#options' => array(
      0 => t('None'),
      1 => t('1 Cols'),
      2 => t('2 Cols'),
  ...
  $form['layout']['footer']['bsb_footer_layout'] = array(
    '#type' => 'select',
    '#title' => t('Footer Regions Position'),
    '#default_value' => theme_get_setting('bsb_footer_layout'),
    '#options' => array(
  ...
  $form['general']['buttons']['bsb_button_size'] = array(
    '#type' => 'select',
    '#title' => t('Default button size'),
    '#default_value' => theme_get_setting('bsb_button_size'),
    '#empty_option' => t('Normal'),
    '#options' => array(
      'btn-sm' => t('Small'),
      'btn-lg' => t('Large'),
    ),
  $form['general']['buttons']['bsb_button_outline'] = array(
    '#type' => 'checkbox',
    '#title' => t('Buttonn with outline format'),
    '#default_value' => theme_get_setting('bsb_button_outline'),
    '#description' => t('Use <code>.btn-default-outline</code> class. See : !bsb_link', array(
      '!bsb_link' => Drupal::l('Outline Buttons' , Url::fromUri('http://getbootstrap.com/css/' , ['absolute' => TRUE , 'fragment' => 'grid-example-fluid'])),
    )),)
  );
  ...
  $form['general']['forms']['bsb_forms_required_has_error'] = array(
    '#type' => 'checkbox',
    '#title' => t('Make required elements display as an error'),
    '#default_value' => theme_get_setting('bsb_forms_required_has_error'),
  ...
  $form['general']['forms']['bsb_forms_smart_descriptions'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('bsb_forms_smart_descriptions'),
  );
  $form['general']['forms']['bsb_forms_smart_descriptions_limit'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => theme_get_setting('bsb_forms_smart_descriptions_limit'),
    '#states' => array(
      'visible' => array(
        ':input[name="bsb_forms_smart_descriptions"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['general']['forms']['bsb_forms_smart_descriptions_allowed_tags'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => theme_get_setting('bsb_forms_smart_descriptions_allowed_tags'),
    '#states' => array(
      'visible' => array(
        ':input[name="bsb_forms_smart_descriptions"]' => array('checked' => TRUE),
      ),
  ...
  $form['components']['navbar']['bsb_navbar_top_position'] = array(
    '#type' => 'select',
    '#title' => t('Navbar top position'),
    '#description' => t('Select your navbar top position.'),
    '#default_value' => theme_get_setting('bsb_navbar_top_position'),
    '#options' => array(
...
//      'scroll-fixed-top' => t('Scroll Fixed Top'),
  ...
  $form['components']['navbar']['bsb_navbar_top_color'] = array(
    '#type' => 'select',
    '#title' => t('Navbar top color'),
    '#description' => t('Select a color for links in navbar top.'),
    '#default_value' => theme_get_setting('bsb_navbar_top_color'),
    '#options' => array(
      'light' => t('Light'),
      'dark' => t('Dark'),
    ),
  ...
  $form['components']['navbar']['bsb_navbar_top_background'] = array(
    '#type' => 'select',
    '#title' => t('Navbar top background'),
    '#description' => t('Select a color for background in navbar top.'),
    '#default_value' => theme_get_setting('bsb_navbar_top_background'),
    '#options' => array(
      'primary' => t('Primary'),
      'faded' => t('Faded'),
      'inverse' => t('Inverse'),
  ...
  $form['components']['navbar']['bsb_navbar_position'] = array(
    '#type' => 'select',
    '#title' => t('Navbar Position'),
    '#description' => t('Select your Navbar position.'),
    '#default_value' => theme_get_setting('bsb_navbar_position'),
    '#options' => array(
      'fixed-top' => t('Fixed Top'),
//      'scroll-fixed-top' => t('Scroll Fixed Top'),
      'fixed-bottom' => t('Fixed Bottom'),
  ...
  $form['components']['navbar']['bsb_navbar_color'] = array(
    '#type' => 'select',
    '#title' => t('Navbar link color'),
    '#description' => t('Select a color for links in navbar style.'),
    '#default_value' => theme_get_setting('bsb_navbar_color'),
    '#options' => array(
      'light' => t('Light'),
      'dark' => t('Dark'),
    ),
  ...
  $form['components']['navbar']['bsb_navbar_background'] = array(
    '#type' => 'select',
    '#title' => t('Backgroun navbar'),
    '#description' => t('Select a color for background in navbar.'),
    '#default_value' => theme_get_setting('bsb_navbar_background'),
    '#options' => array(
      'primary' => t('Primary'),
      'faded' => t('Faded'),
      'inverse' => t('Inverse'),
  ...
  $form['javascript']['anchors']['bsb_anchors_fix'] = array(
    '#type' => 'checkbox',
    '#title' => t('Fix anchor positions'),
    '#default_value' => theme_get_setting('bsb_anchors_fix'),
  ...
  $form['javascript']['anchors']['bsb_anchors_smooth_scrolling'] = array(
    '#type' => 'checkbox',
    '#title' => t('Enable smooth scrolling'),
    '#default_value' => theme_get_setting('bsb_anchors_smooth_scrolling'),
    '#description' => t('Animates page by scrolling to an anchor link target smoothly when clicked.'),
    '#states' => array(
      'invisible' => array(
        ':input[name="bsb_anchors_fix"]' => array('checked' => FALSE),
      ),
    ),
  );
  ...
  $form['javascript']['popovers']['bsb_popover_enabled'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('bsb_popover_enabled'),
  );
  $form['javascript']['popovers']['options'] = array(
    ...
    '#states' => array(
      'visible' => array(
        ':input[name="bsb_popover_enabled"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['javascript']['popovers']['options']['bsb_popover_animation'] = array(
    '#type' => 'checkbox',
    '#title' => t('animate'),
    '#description' => t('Apply a CSS fade transition to the popover.'),
    '#default_value' => theme_get_setting('bsb_popover_animation'),
  );
  $form['javascript']['popovers']['options']['popover_html'] = array(
    ...
    '#default_value' => theme_get_setting('bsb_popover_html'),
  );
  $options = array(
    'top',
    'bottom',
  ...
  $form['javascript']['popovers']['options']['bsb_popover_placement'] = array(
    '#type' => 'select',
    '#title' => t('placement'),
    ...
    '#default_value' => theme_get_setting('bsb_popover_placement'),
    '#options' => array_combine($options, $options),
  );
  $form['javascript']['popovers']['options']['bsb_popover_selector'] = array(
    '#type' => 'textfield',
    '#title' => t('selector'),
    ...
    '#default_value' => theme_get_setting('bsb_popover_selector'),
  );
  $options = array(
    'click',
    'hover',
  ...
  $form['javascript']['popovers']['options']['bsb_popover_trigger'] = array(
    '#type' => 'checkboxes',
    '#title' => t('trigger'),
    '#description' => t('How a popover is triggered.'),
    '#default_value' => theme_get_setting('bsb_popover_trigger'),
    '#options' => array_combine($options, $options),
  );
  $form['javascript']['popovers']['options']['bsb_popover_trigger_autoclose'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('bsb_popover_trigger_autoclose'),
  );
  $form['javascript']['popovers']['options']['bsb_popover_title'] = array(
    '#type' => 'textfield',
    '#title' => t('title'),
    '#description' => t("Default title value if \"title\" attribute isn't present."),
    '#default_value' => theme_get_setting('bsb_popover_title'),
  );
  $form['javascript']['popovers']['options']['bsb_popover_content'] = array(
    '#type' => 'textfield',
    '#title' => t('content'),
    '#description' => t('Default content value if "data-content" or "data-target" attributes are not present.'),
    '#default_value' => theme_get_setting('bsb_popover_content'),
  );
  $form['javascript']['popovers']['options']['bsb_popover_delay'] = array(
    '#type' => 'textfield',
    '#title' => t('delay'),
    ...
    '#default_value' => theme_get_setting('bsb_popover_delay'),
  );
  $form['javascript']['popovers']['options']['bsb_popover_container'] = array(
    '#type' => 'textfield',
    '#title' => t('container'),
    ...
    '#default_value' => theme_get_setting('bsb_popover_container'),
  );
  ...
  $form['javascript']['tooltips']['bsb_tooltip_enabled'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('bsb_tooltip_enabled'),
  );
  $form['javascript']['tooltips']['options'] = array(
    ...
    '#states' => array(
      'visible' => array(
        ':input[name="bsb_tooltip_enabled"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['javascript']['tooltips']['options']['bsb_tooltip_animation'] = array(
    '#type' => 'checkbox',
    '#title' => t('animate'),
    '#description' => t('Apply a CSS fade transition to the tooltip.'),
    '#default_value' => theme_get_setting('bsb_tooltip_animation'),
  );
  $form['javascript']['tooltips']['options']['bsb_tooltip_html'] = array(
    '#type' => 'checkbox',
    '#title' => t('HTML'),
    ...
    '#default_value' => theme_get_setting('bsb_tooltip_html'),
  );
  $options = array(
    'top',
    'bottom',
  ...
  $form['javascript']['tooltips']['options']['bsb_tooltip_placement'] = array(
    '#type' => 'select',
    '#title' => t('placement'),
    ...
    '#default_value' => theme_get_setting('bsb_tooltip_placement'),
    '#options' => array_combine($options, $options),
  );
  $form['javascript']['tooltips']['options']['bsb_tooltip_selector'] = array(
    '#type' => 'textfield',
    '#title' => t('selector'),
    '#description' => t('If a selector is provided, tooltip objects will be delegated to the specified targets.'),
    '#default_value' => theme_get_setting('bsb_tooltip_selector'),
  );
  $options = array(
    'click',
    'hover',
  ...
  $form['javascript']['tooltips']['options']['bsb_tooltip_trigger'] = array(
    '#type' => 'checkboxes',
    '#title' => t('trigger'),
    '#description' => t('How a tooltip is triggered.'),
    '#default_value' => theme_get_setting('bsb_tooltip_trigger'),
    '#options' => array_combine($options, $options),
  );
  $form['javascript']['tooltips']['options']['bsb_tooltip_delay'] = array(
    '#type' => 'textfield',
    '#title' => t('delay'),
    ...
    '#default_value' => theme_get_setting('bsb_tooltip_delay'),
  );
  $form['javascript']['tooltips']['options']['bsb_tooltip_container'] = array(
    '#type' => 'textfield',
    '#title' => t('container'),
    '#description' => t('Appends the tooltip to a specific element. Example: "body"'),
    '#default_value' => theme_get_setting('bsb_tooltip_container'),
  );
